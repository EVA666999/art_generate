#!/usr/bin/env python3
"""
Тест минимального конфига ADetailer
"""
import asyncio
import httpx
import json
...
async def test_minimal_adetailer():
    ...
    print("🔍 ТЕСТ МИНИМАЛЬНОГО КОНФИГА ADETAILER")
    print("=" * 50)
    ...
    async with httpx.AsyncClient(timeout=120.0) as client:
        try:
            ...
            if response.status_code == 200:
                ...
                output_path = Path("trash/minimal_adetailer.png")
...
if __name__ == "__main__":
    asyncio.run(test_minimal_adetailer()) 