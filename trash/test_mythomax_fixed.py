#!/usr/bin/env python3
"""
Тестовый скрипт для проверки исправлений MythoMax формата.
"""
...
async def test_mythomax_fixed():
    """Тестирует исправленный MythoMax формат"""
    
    print("🧪 Тестирование исправлений MythoMax формата...")
...
if __name__ == "__main__":
    print("🚀 Запуск теста исправлений MythoMax формата...")
    print("=" * 50)
    
    asyncio.run(test_mythomax_fixed())
